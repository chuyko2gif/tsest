...
export default function ToastNotification({ show, message = 'Скопировано' }: ToastNotificationProps) {
  if (!show) return null;

  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
      <div className="relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 border border-white/20 rounded-2xl px-8 py-4 shadow-2xl pointer-events-auto backdrop-blur-xl animate-slide-in"
