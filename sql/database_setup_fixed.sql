-- =====================================================
-- THQ LABEL - ИСПРАВЛЕННАЯ НАСТРОЙКА БАЗЫ ДАННЫХ
-- Запустите этот скрипт в Supabase SQL Editor
-- =====================================================

-- СНАЧАЛА СОЗДАЁМ ВСЕ ТАБЛИЦЫ (БЕЗ ПОЛИТИК)
-- =====================================================
...
-- =====================================================
-- ТЕПЕРЬ ВКЛЮЧАЕМ RLS ДЛЯ ВСЕХ ТАБЛИЦ
-- =====================================================
...
-- Создаём её ДО политик, чтобы избежать рекурсии
-- =====================================================
...
-- Пользователи создают свой профиль
CREATE POLICY "Users can insert own profile" ON profiles
  FOR INSERT WITH CHECK (auth.uid() = id);

-- Админы видят все профили (используем функцию)
CREATE POLICY "Admins can view all profiles" ON profiles
  FOR SELECT USING (is_admin());


-- =====================================================
-- ПОЛИТИКИ ДЛЯ RELEASES
-- =====================================================
